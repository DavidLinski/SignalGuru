...
public class Frame_Performances extends android.app.Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		...
		viewHierarchy = inflater.inflate(R.layout.activity_performances,container, false);
		createController();
	...
	public void createController() {
		...
		webview.loadUrl(LinksBank.PERFORMANCES);
